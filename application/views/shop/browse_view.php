			...
			<div class="span12">
				...
				<li class="span3">
		          <div class="thumbnail">
					...
					<img class="imgsize" src="<?php if(count($items_img[$row*4 + $column]) != 0 && !is_null($items_img[$row*4 + $column]['thumb_address'])) echo base_url().$items_img[$row*4 + $column]['thumb_address']; else echo 'http://placehold.it/300x200'; ?>" /></a>
		            <div class="caption">
