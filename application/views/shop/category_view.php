			...
			<?php if(isset($lv_cat) && count($lv_cat) > 0): ?>
				...
				<li class="span4">
		          <div class="thumbnail">
					...
					<img class="imgsize" src="<?php if(is_null($lv_cat[$row*3 + $column]['img_address'])) echo 'http://placehold.it/300x200'; else echo base_url().$lv_cat[$row*3 + $column]['img_address']; ?>"></a>
		            <div class="caption">
