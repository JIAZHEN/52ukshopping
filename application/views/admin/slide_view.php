<div class="span2">
	<ul class="nav nav-list">
	    <li class="nav-header">用户管理</li>
		    ...
		    <li<?php if($active_option == 'users_add') echo ' class="active"'; ?>><a href="#"><i class="icon-plus"></i>添加用户</a></li>
	    <li class="nav-header">商品管理</li>
		    ...
		    <li<?php if($active_option == 'skus_edit') echo ' class="active"'; ?>><a href="#"><i class="icon-pencil"></i>编辑商品</a></li>
		    <li<?php if($active_option == 'skus_add') echo ' class="active"'; ?>><a href="#"><i class="icon-plus"></i>添加商品</a></li>
