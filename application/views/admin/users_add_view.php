...
<form class="form-horizontal" method="post" action="<?php echo base_url()."admin/add_user"; ?>" >
<fieldset>
...
<div class="control-group">
  ...
  <div class="controls">
    <div class="input-append date" id="birthday" data-date="1985-01-01" data-date-format="yyyy-mm-dd">
		<input class="input-medium" name="birthday" type="text" value="<?php echo set_value('birthday'); ?>" readonly>
